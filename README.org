...
- [[#flashing-the-firmware][Flashing the firmware]]
  - [[#a-word-about-trackball-modes][A word about trackball modes]]
    ...
    - [[#dragscroll-mode][Dragscroll mode]]
    - [[#sniping-mode][Sniping mode]]
...
*** Sniping mode
Decreases the cursors sensitivity during cursor mode, allowing you to click on something way easier.
...
| Keycode                     | Function                                                                     |
|-----------------------------+------------------------------------------------------------------------------|
| POINTER_DEFAULT_DPI_FORWARD | Increase the sensitivity in cursor mode / decrease it when shift is pressed  |
| POINTER_DEFAULT_DPI_REVERSE | Decrease the sensitivity in cursor mode / increase it when shift is pressed  |
| POINTER_SNIPING_DPI_FORWARD | Increase the sensitivity in sniping mode / decrease it when shift is pressed |
| POINTER_SNIPING_DPI_REVERSE | Decrease the sensitivity in sniping mode / increase it when shift is pressed |
| SNIPING_MODE                | Activates sniping mode while key is pressed                                  |
| SNIPING_MODE_TOGGLE         | Toggles sniping mode                                                         |
| DRAGSCROLL_MODE             | Activates dragscroll mode while key is pressed                               |
| DRAGSCROLL_MODE_TOGGLE      | Toggles dragscroll mode                                                      |
|-----------------------------+------------------------------------------------------------------------------|
