...
- [[#flashing-the-firmware][Flashing the firmware]]
  - [[#a-word-about-trackball-modes][A word about trackball modes]]
    ...
    - [[#for-the-vim-lovers][For the vim lovers]]
...
*** For the vim lovers
I have found myself pressing on ESC often, when trying to get to cursor mode. Seems like Vims modes really are in my blood by now. So I made a little function to accommodate this.
To switch between modes you can either just tap the corresponding key, but you could also use the ESC key (with the keycode ~TD(ESC_TM)~) to get back to cursor mode (which is like Vims normal mode so to speak). Be aware that this still acts like a normal press on ESC, so you end up pressing ESC in the program that has mouse focus.
...
| TD(ESC_TM)  | activate cursor mode                                                                                          |
|-------------+---------------------------------------------------------------------------------------------------------------|
...
| MD(1)   | TD(LOW_TM)                                                                     |
| MD(2)   | TD(RAI_TM)                                                                     |
| KC_ESC  | TD(ESC_TM) (if you want to go back to cursor mode every time you press escape) |
|---------+--------------------------------------------------------------------------------|
